...
\newcommand{\Simp}[1]{{\textbf{Simp}(#1)}}   % Simplicial category
...
\newcommand{\simhtrel}[1]{\sim_{\text{rel }{#1}}}
\newcommand{\isoht}{\iso_{\text{h}}} % Homotopy equivalence
\newcommand{\htpy}{\Rightarrow}
\newcommand{\htpyrel}[1]{\Rightarrow_{\text{rel }{#1}}}
