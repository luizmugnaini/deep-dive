...
\vfill
\begin{center}
    {\small Source: \url{https://github.com/luizmugnaini/deep-dive}}
\end{center}
...
% handles poorly the spacing between the roman numbers and the title, which is
...
\subfile{src/topology/algebraic-topology/main-algebraic-topology}
...
\subfile{src/differentiable/complex-analysis/main-complex-analysis}

\subfile{src/differentiable/functional-analysis/main-functional-analysis}

\part{~~Machine Learning}

\subfile{src/machine-learning/main-ml}
