...
tower
\[
  H \supsetneq H_0 \supsetneq \dots \supseteq H_m = \{e\}.
\]
...
\(G\), thus
\[
  G = G_0 \supsetneq G_1 \supsetneq \dots \supsetneq G_m \supseteq \{e\}.
\]
...
N)/N \supsetneq \dots \supseteq (G_n N)/N = (\{e\} N)/N = N\) --- where
...
\supsetneq \dots \supseteq Q_m = \{e\}\). Since \(H_j \coloneq \{g N \colon g
