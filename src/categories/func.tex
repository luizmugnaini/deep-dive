...
% \(\lambda: \El_F([\cat C^{\op}, \Set]) \to [\El_F(\cat C)^{\op}, \Set]\): fix
% any presheaf \(G: \cat C^{\op} \to \Set\) and a natural transformation
% \(\tau: G \nat F\), for every
% \end{proof}

\todo[inline]{I don't really understand this statement}
