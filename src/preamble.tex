...
\newcommand{\pTop}{{\catfont{Top}^{*}}}
\newcommand{\bpTop}{{\catfont{Top}^{*/}}}
\newcommand{\Ho}[1]{{\catfont{Ho}(#1)}}
\newcommand{\HoTop}{{\catfont{Ho}(\catfont{Top})}} % Homotopy space
\newcommand{\Splx}{{\mathbf{\Delta}}} % Simplex category
\newcommand{\sSet}{{\catfont{sSet}}}        % Simplicial sets
\newcommand{\CoSimp}[1]{{\catfont{CoSimp}(#1)}} % Category of cosimplicial objects
